<?php
/**
 * Attend Ease - Student Registration
 *
 * @package AttendEase
 */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    if (!validateCsrfToken($_POST['csrf_token'] ?? '')) {
        ...
        if (empty($fullName) || empty($email) || empty($password)) {
            ...
            if ($existing > 0) {
                $error = 'This email is already registered. <a href="' . BASE_URL . 'student/login.php">Log in instead?</a>';
            } else {
...
$pageTitle = 'Student Sign Up | ' . APP_NAME;
$basePath = '../';
$pageCss = 'auth';
        ...
        <div class="auth-card" style="max-width: 480px;">
            ...
            <?php if ($success): ?>
                <div class="alert alert-success" style="text-align:center;">
                    ...
                    <?php echo $success; ?>
                    <a href="<?php echo BASE_URL; ?>student/login.php" class="btn btn-student btn-block" style="margin-top:1rem;">Log In Now</a>
                </div>
            <?php else: ?>
                <form method="POST" action="" class="auth-form" id="signupForm">
                    ...
                    <button type="submit" class="btn btn-student btn-block" style="margin-top:0.5rem;">
            ...
            <div class="auth-footer">
                <p>Already have an account? <a href="<?php echo BASE_URL; ?>student/login.php">Log In</a></p>
                <p><a href="<?php echo BASE_URL; ?>teacher/register.php">Sign Up as Teacher</a></p>
